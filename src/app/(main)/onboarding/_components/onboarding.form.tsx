    ...
    <div className="flex items-center justify-center bg-background">
      <Card className="w-full max-w-lg mt-10 mx-2">
        <CardHeader>
          ...
          <CardDescription>Select your industry to get persionalized career insights and recommendations</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            </div>
            {
              ...
              <div className='space-y-2'>
                ...
                <Select onValueChange={handleSetSubIndustryValue}>
                  ...
                  <SelectContent>
                    {selectedIndustry && selectedIndustry?.subIndustries.map((subIndustry) => (
